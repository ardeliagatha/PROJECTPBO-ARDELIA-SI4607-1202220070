...
public class KampusApp {
    ...
    public KampusApp() {
        ...
        Prodi prodi1 = new Prodi("1", "Sistem Informasi");
        Prodi prodi2 = new Prodi("2", "Teknik Industri");
        Prodi prodi3 = new Prodi("3", "Informatika");

        db.prodiTbl.create(prodi1);
        db.prodiTbl.create(prodi2);
        db.prodiTbl.create(prodi3);
    }
    ...
    public void menuTambah() {
        ...
        String namaProdi = db.prodiTbl.getProdiNameById(idProdi);
        if (!namaProdi.equals("Prodi tidak ditemukan")) {
            Mahasiswa mahasiswa = new Mahasiswa(nim, nama, idProdi);
            db.mahasiswaTbl.create(mahasiswa, idProdi);
    ...
    public void menuUbah() {
        ...
        if (!namaProdi.equals("Prodi tidak ditemukan")) {
            ...
            db.mahasiswaTbl.update(nimLama, mahasiswa, idProdi);
    ...
    public void menuCari(){
        ...
        if(mahasiswa == null) {
            ...
            System.out.println("* Prodi: " + db.prodiTbl.getProdiNameById(mahasiswa.getIdProdi()) + " *");
        }
        System.out.println("Tekan Enter untuk melanjutkan...");
        scanner.nextLine();
        showMenu();
